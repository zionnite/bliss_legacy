...
class _ConnectionPageState extends State<ConnectionPage> {
  ...
  checkIfListLoaded() {
    var loading = conController.isConnectionProcessing;
  ...
  Widget detail() {
    return (conController.connectionList.isEmpty)
        ? Stack(children: [
            const ShowNotFound(),
            Positioned(
              bottom: 10,
              ...
              child: InkWell(
                onTap: () {
                  setState(() {
                    conController.isConnectionProcessing.value = 'null';
                    conController.fetchConnection(1, user_id);
                    conController.connectionList.refresh();
                  });
                },
                child: Container(
